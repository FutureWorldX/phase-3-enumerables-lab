...
# this method makes sure that the emoji can be used in more methods
def heat_level_emoji(level)
  '🌶' * level
end
...
def print_spicy_foods(spicy_foods)
  ...
  spicy_foods.each do |food|
    puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{heat_level_emoji(food[:heat_level])}"
  end
end
